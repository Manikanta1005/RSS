                        ...
                        if(allLetter(dest)){
                            if(allnum(sleeper)){
                                if(allnum(ac)){
                                    if(allnum(noof)){
                                        if(noof.value<2){
                                            alert("no of stations minimum 2");
                                        }
                                        else{
                                        return true;}
                                    }
...
<body>
    ...
    %>
                   ...
                   <h2 align="center" >Train already got registered </h2>
           <%}
else{%>
<h2 align="center" >Station was not found in the list </h2>
<%
...
<%
    ...
    <div class="container">
        ...
        <h2 align="center">New Train </h2>
        <form name="reg" action="newtrain.jsp" onSubmit="return formValidation();">
            <table cellpadding="5" align="center">
                <tr>
                    <td><b>TrainNO</b></td>
                    <td><input type="text" name="trainno"  onkeyup="sendInfo()" required/></td>
                </tr>
                ...
                <tr>
                    <td><b>Source:</b></td>
                    <td><input list="station" name="source" required/></td>
                </tr>
                <tr>
                    <td><b>Destination</b></td>
                    <td><input list="station" name="destination" required/></td>
                </tr>
                <tr>
                    <td><b>NoOfSleeper</b></td>
                    <td><input type="text" name="sleeper" required/></td>
                </tr>
                <tr>
                    <td><b>NoOfAC</b></td>
                ...
                <tr>
                    ...
                    <td><input type="test" name="noofstations" required/></td>
                </tr>
 
                <tr>
                    <td colspan="2" align="center"><input class="button" type="submit" value="Add Train"/></td>
